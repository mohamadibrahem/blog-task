...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blogs.store") }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="user_by_id" value="{{ auth::id() }}"/>
            ...
            <div class="form-group">
                <label class="required" for="publish_date">{{ trans('cruds.blog.fields.publish_date') }}</label>
                <input class="form-control date {{ $errors->has('publish_date') ? 'is-invalid' : '' }}" type="text" name="publish_date" id="publish_date" value="{{ old('publish_date') }}" required>
