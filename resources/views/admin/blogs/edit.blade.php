...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blogs.update", [$blog->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <input type="hidden" name="user_by_id" value="{{ $blog->user_by_id ?? '' }}"/>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('publish_date') ? 'is-invalid' : '' }}" type="text" name="publish_date" id="publish_date" value="{{ old('publish_date', $blog->publish_date) }}" required>
